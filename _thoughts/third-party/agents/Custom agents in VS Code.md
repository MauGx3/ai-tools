---
created: 2025-11-20T12:38:01 (UTC -03:00)
tags: []
...
## [What are custom agents?](https://code.visualstudio.com/docs/copilot/customization/custom-agents#_what-are-custom-agents)

The [built-in agents](https://code.visualstudio.com/docs/copilot/chat/copilot-chat#_switch-between-agents) provide general-purpose configurations for chat in VS Code. For a more tailored chat experience, you can create your own custom agents.
...
## [Why use custom agents?](https://code.visualstudio.com/docs/copilot/customization/custom-agents#_why-use-custom-agents)
...
### [Body](https://code.visualstudio.com/docs/copilot/customization/custom-agents#_body)
...
1.  Select **Configure Custom Agents** from the agents dropdown and then select **Create new custom agent** or run the **Chat: New Custom Agent** command in the Command Palette (⇧⌘P).
...
## [Customize the agents dropdown list](https://code.visualstudio.com/docs/copilot/customization/custom-agents#_customize-the-agents-dropdown-list)
...
## [Frequently asked questions](https://code.visualstudio.com/docs/copilot/customization/custom-agents#_frequently-asked-questions)

### [Are custom agents different from chat modes?](https://code.visualstudio.com/docs/copilot/customization/custom-agents#_are-custom-agents-different-from-chat-modes)
